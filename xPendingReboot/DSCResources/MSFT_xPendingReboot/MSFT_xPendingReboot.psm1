...
Function Test-TargetResource
{
	...
	# Check if rebootpending registry key is present
	#$rebootKey = Get-Item -LiteralPath 'HKLM:SOFTWARE\Microsoft\Windows\CurrentVersion\Component Based Servicing\RebootPending' -ErrorAction SilentlyContinue
	#if($rebootKey -ne $null){
